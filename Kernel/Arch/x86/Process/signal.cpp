...
namespace ProcessManager::Arch
{
    ...
    void HandleSignal(THREAD *thread, int signo, sig_t handler)
    {
        uint8 instructions[] = {
            0x60,                                     // pusha
            0x0f, 0xae, 0x05, 0x00, 0x00, 0x00, 0x00, // fxsave FPU_STATE
            0x6a, (uint8)signo,                       // push SIGNO
            0xbb, 0x00, 0x00, 0x00, 0x00,             // mob ebx, HANDLER
            0xff, 0xd3,                               // call ebx
            0x0f, 0xae, 0x0d, 0x00, 0x00, 0x00, 0x00, // fxrstor FPU_STATE
            0x61,                                     // popa
            0xbe, 0x00, 0x00, 0x00, 0x00,             // mov esi, INFO
            0xb8, SYSCALL_SIGRETURN, 0x0, 0x0, 0x0,   // mov eax, SIGRETURN
