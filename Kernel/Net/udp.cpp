...
NetPacket* UDP::CreatePacket(NetInterface* intf, IPv4Address dst, uint16 src_port, uint16 dst_port, uint8* data, uint32 data_length)
{
...
void UDP::Receive(NetInterface* intf, IPv4_Header* ip_hdr, NetPacket* pkt)
{
...
bool UDP::Decode(UDP_Packet* up, NetPacket* pkt)
{
