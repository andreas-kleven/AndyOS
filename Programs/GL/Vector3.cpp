...
mat.elems[3]; float ny = mat.elems[4] * vec.x + mat.elems[5] * vec.y + mat.elems[6] * vec.z +
mat.elems[7]; float nz = mat.elems[8] * vec.x + mat.elems[9] * vec.y + mat.elems[10] * vec.z +
mat.elems[11]; return Vector3(nx, ny, nz);
}*/
