...
class Game
{
  public:
    ...
    template <class T> T *CreateCamera(const std::string &name);

    template <class T> T *CreateLightSource(const std::string &name);
...
template <class T> T *Game::CreateCamera(const std::string &name)
{
    Camera *t = new T;
    t->SetName(name);
    AddCamera(t);
...
template <class T> T *Game::CreateLightSource(const std::string &name)
{
    LightSource *t = new T;
    t->SetName(name);
    AddLightSource(t);
