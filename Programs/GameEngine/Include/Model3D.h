...
struct Triangle
{
    ...
    Vector3 Center() { return (v0->pos + v1->pos + v2->pos).ToVector3() / 3; }
    ...
    Vertex *&Get(int index)
    {
        ...
        // Exceptions::ThrowException("Index out of range exception", "Vertex index must be in the
        // range 0-2");
    }

    Vertex *&operator[](int index) { return Get(index); }
};
